...
import 'package:flutter_complete_guide/Api/login_screen_model.dart';
import 'package:flutter_complete_guide/Model/login_response_data.dart';
                ...
                Container(
                  ...
                  child: Platform.isAndroid
                      ? FlatButton(
                          ...
                          onPressed: () {
                            // print("the message in ${_loginResponse.message}");
